...
var fileName = '';
routerInpage.get('/', function(req, res, next) {
    res.render(path.resolve(__dirname, '../src/views/popup/popup'));
});
var title = '';
...
routerInpage.post('/upload_popup', upload.any(), function(req, res, next) {
    ...
    switch(site) {
        case 0:
            ...
            break;
        case 1:
            site = './public/site/page_popup/kenh14.html';
            break;
        case 2:
            site = './public/site/page_popup/afamily.html';
            break;
        case 3:
            site = './public/site/page_popup/cafef.html';
            break;
        case 4:
            site = './public/site/page_popup/gdn.html';
            break;
        default:
            site = './public/site/page_popup/dantri.html';
    }
